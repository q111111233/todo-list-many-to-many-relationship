...
namespace ToDoList
{
  public class Task
  {
    ...
    public Task(string Description, bool taskComplete = false, int Id = 0)
    {
      _id = Id;
    ...
    public void Save()
    {
      ...
      SqlCommand cmd = new SqlCommand("INSERT INTO tasks (description, taskComplete) OUTPUT INSERTED.id VALUES (@TaskDescription, @taskComplete)", conn);
